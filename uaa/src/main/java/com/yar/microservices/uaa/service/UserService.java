...
import com.yar.microservices.uaa.service.util.RandomUtil;
...
public class UserService {
    ...
    public Optional<UserDTO> updateUser(UserDTO userDTO) {
        ...
        /*return Optional.of(userRepository
                ...
                .map(user -> {
                    ...
                    user.get().setLangKey(userDTO.getLangKey());
    ...
    public Page<UserDTO> getAllManagedUsers(Pageable pageable) {
        Page<User> allByLoginNot = userRepository.findAllByLoginNot(pageable, SecurityAuthority.ANONYMOUS.getAuthority());
        List<UserDTO> userDTOS = new ArrayList<>();

        for (User user : allByLoginNot.getContent()){
